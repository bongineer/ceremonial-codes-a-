                ...
                <div key={index} className="bg-theme-card-bg rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  <div className="flex items-center space-x-4">
                    <img 
                      src={member.imageUrl} 
                      alt={member.name}
                      className="w-21 h-20 rounded-full object-cover border-4 border-theme-secondary"
                    />
                    <div>
                ...
                <div key={index} className="bg-theme-card-bg rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  <div className="flex items-center space-x-4">
                    <img 
                      src={member.imageUrl} 
                      alt={member.name}
                      className="w-25 h-25 rounded-full object-cover border-4 border-theme-secondary"
                    />
                    <div>
                      <h4 className="text-lg font-semibold text-theme-text">{member.name}</h4>
                      <p className="text-theme-primary font-medium">{member.role}</p>
