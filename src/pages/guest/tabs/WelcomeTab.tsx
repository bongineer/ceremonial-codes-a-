    ...
    <BackgroundImage imageUrl={welcomeImages[0]}>
      <div>
        ...
        <div className="bg-theme-card-bg rounded-lg shadow-md p-8 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="mb-4 text-theme-text">We met in Lokoja where I was a 200L student, and he was working as an engineer at Dangote Ind. After a late class, I was walking back to my hostel when I saw a ride dropping off a passenger—him. Just as I was about to get in, he delayed the driver. I thought he was paying for his ride, but he was trying to talk to me and get my contact.</p>
